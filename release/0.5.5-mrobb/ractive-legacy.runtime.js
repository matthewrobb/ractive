/*
	ractive-legacy.runtime.js v0.5.5-mrobb
	2014-08-04 - commit 580320af 
...
( function( global ) {
	...
	var virtualdom_items_Element$init = function( types, enforceCase, createAttributes, createTwowayBinding, createEventHandlers, Decorator, bubbleSelect, initOption, getComponent, Component, circular ) {
		...
		return function Element$init( options ) {
			var parentFragment, template, ractive, Custom, binding, bindings;
	...
	}( types, enforceCase, virtualdom_items_Element$init_createAttributes, virtualdom_items_Element$init_createTwowayBinding, virtualdom_items_Element$init_createEventHandlers, Decorator, bubble, init, getComponent, Component, circular );
	...
	var virtualdom_Fragment$init_createItem = function( types, Text, Interpolator, Section, Triple, Element, Partial, Comment ) {
	...
	}( types, Text, Interpolator, Section, Triple, Element, Partial, Comment );
